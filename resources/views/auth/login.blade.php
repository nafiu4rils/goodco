...
<div class="w3-border" style="height:300px;width:auto;">
     ...
     <h1  class="w3-animate-right w3-center"><u>Login Here</u></h1>
     <p class="w3-animate-right w3-center">Fill in your Information to Login</p>  
</div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card" style="background-color:black;">
                <div class="card-header" style="background-color:blue;color:white;font-weight:bolder;text-align:center;">{{ __('Login') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}" style="text-decoration:none;">
                        @csrf
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="remember" style="color:white;font-weight:bolder;">
                                        {{ __('Remember Me') }}
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                @if (Route::has('password.request'))
                                    <a class="btn btn-link" href="{{ route('password.request') }}"style="color:white;font-weight:bolder;">
...
<div class="w3-border w3-mobile" style="height:300px;width:auto;">
  <h1  class="w3-animate-right w3-center"><u>Head Quarters</u></h1>
   <p class="w3-animate-zoom" align="center" style="font-weight:bolder;">
    Head quarters staff should Login to access their dashboard and application portal.           
   </p>
</div>
<div class="w3-border w3-mobile" style="height:300px;width:auto;">
...
<div class="w3-border w3-mobile" style="height:300px;width:auto;">
  <h1  class="w3-animate-right w3-center"><u>Sweden office</u></h1>
   <p class="w3-animate-zoom" align="center" style="font-weight:bolder;">
      staffs in sweden should Login to access their dashboard and application portal.
   </p>
</div>
<div class="w3-border w3-mobile" style="height:300px;width:auto;">
...
<div class="w3-border w3-mobile" style="height:300px;width:auto;">
  <h1  class="w3-animate-right w3-center"><u>London office</u></h1>
   <p class="w3-animate-zoom" align="center" style="font-weight:bolder;">
      staffs in London should Login to access their dashboard and application portal.
   </p>
</div>
<div class="w3-border w3-mobile" style="height:300px;width:auto;">
...
<div class="w3-border w3-mobile" style="height:300px;width:auto;">
  <h1  class="w3-animate-right w3-center"><u>Canada office</u></h1>
   <p class="w3-animate-zoom" align="center" style="font-weight:bolder;">
     staffs in Canada should Login to access their dashboard and application portal.
   </p>
</div>
<div class="w3-border w3-mobile" style="height:300px;width:auto;">
...
<div class="w3-border w3-mobile" style="height:300px;width:auto;">
  <h1  class="w3-animate-right w3-center"><u>Netherlands office</u></h1>
   <p class="w3-animate-zoom" align="center" style="font-weight:bolder;">
      staffs in Netherlands should Login to access their dashboard and application portal.
   </p>
</div>
